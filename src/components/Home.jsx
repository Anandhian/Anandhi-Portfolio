...
import anandhi from '../assets/images/anandhi.pdf'

const Home = () => {
  return (
    <div id='home' className='w-11/12 mx-auto py-11 my-auto   text-center max-w-3xl  h-screen  flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-col lg:flex-row md:flex-row gap-2 mt-4'>
        ...
        <a href={anandhi} download className='px-10 py-3 border rounded-full flex items-center border-gray-500 gap-2'>
          My resume
